...
Public Class dlgNewTable
    ...
    Private Sub ToolTipfrm()
        With Me
            ...
            .ToolTip1.SetToolTip(.optPage, "New table for sheet sizes, excluding sheet margins")
            .ToolTip1.SetToolTip(.optInside, "New table for the size of the selected figure")
            .ToolTip1.SetToolTip(.ckbDelShape, "Delete an outline shape")
            .ToolTip1.SetToolTip(.nudColumns, "Number of columns in the new table")
            .ToolTip1.SetToolTip(.nudRows, "Number of rows in the new table")
            .ToolTip1.SetToolTip(.txtCellDefWidth, "Width of cells in new table")
            .ToolTip1.SetToolTip(.txtCellDefHeight, "Height of cells in new table")
            .ToolTip1.SetToolTip(.txtTableCusWidth, "New table width")
            .ToolTip1.SetToolTip(.txtTableCusHeight, "New table height")
        End With
    End Sub
