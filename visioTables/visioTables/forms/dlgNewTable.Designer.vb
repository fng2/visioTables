...
Partial Class dlgNewTable
    ...
    Private Sub InitializeComponent()
        ...
        Me.optInside.Tag = ""
        Me.optInside.Text = "Inside the figure"
        ...
        Me.ckbDelShape.Text = "Delete a figure"
        ...
        Me.Label7.Tag = ""
        Me.Label7.Text = "Table name (not necessary)"
        '
        'txtNameTable
        '
